...
<form action="proedit_karyawan.php" method="POST" enctype="multipart/form-data">
  ...
  <div class="form-group">
    ...
    <input type="text" class="form-control" name="Nik" autocomplete="off" value="<?php echo $d['Nik'];?>">
  </div>  
  <div class="form-group">
  ...
  <div class="form-group">
    <label for="exampleInputPassword1">Tanggal Gabung</label>
    <textarea autocomplete="off" class="form-control" name="tgl_gabung" value="<?php echo $d['tgl_gabung'];?>"></textarea>
