                            ...
                            <form action="dt_karyawan_sv.php" enctype="multipart/form-data" method="post">
                                ...
                                <table class="table table-borderless table-striped table-earning" >
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td>Nik</td>
                                                <td><input type="text" class="form-control" required="" name="Nik" autocomplete="off"></td>
                                                </tr>
                                            ...
                                            <tr>    
                                                ...
                                                <td><input type="text" class="form-control" required="" name="tgl_gabung" autocomplete="off"></td>
                                            </tr>
                                            <tr>
                                                <td>Jabatan</td>
                                                <td>
