...
//proses hapus gambar
      ...
      $sql_f = "UPDATE tb_karyawan set username='$username', password='$password', nama='$nama',Nik='$Nik', tmp_tgl_lahir='$tmp_tgl_lahir', jenkel='$jenkel', agama='$agama', alamat='$alamat', no_tel='$no_tel',Pendidikan='$Pendidikan', jabatan='$jabatan',tgl_gabung='$tgl_gabung', foto ='$fotobaru' WHERE id_karyawan='$id_karyawan'";
   ...
   $sql_d   = "UPDATE tb_karyawan set username='$username', password='$password', nama='$nama',Nik='$Nik', tmp_tgl_lahir='$tmp_tgl_lahir', jenkel='$jenkel', agama='$agama', alamat='$alamat', no_tel='$no_tel',Pendidikan='$Pendidikan', jabatan='$jabatan',tgl_gabung='$tgl_gabung' WHERE id_karyawan='$id_karyawan'";
