...
<head>
  ...
  <title>Sistem Informasi Karyawan - Home</title>
	<link rel="icon" href="img/logo bas.png" type="logo bas/png">
...
<body>
  ...
  <main class="side-main">
    ...
    <section class="hero-banner mb-50px">
      <div class="container">
        <div class="row">
          <div class="col-lg-7">
          ...
          <div class="col-lg-5 pt-5">
            <div class="hero-banner__content">
              <h>Absensi Karyawan</h1>
              <h>PT.BARIQ ANUGERAH SEJAHTERA</h1>
              <p>Website ini berfungsi sebagai absensi karyawan PT.Bariq Anugerah Sejahtera.</p>
            </div>
          </div>
        </div>
      </div>
          ...
          <div class="row">
            <div class="col-lg-4">
              <div class="card card-feature text-center text-lg-left mb-4 mb-lg-0">
                ...
                <p class="card-feature__subtitle">@Basbriket</p>
              </div>
            </div>
            <div class="col-lg-4">
              <div class="card card-feature text-center text-lg-left mb-4 mb-lg-0">
                ...
                <h3 class="card-feature__title">Office Telepon</h3>
                <p class="card-feature__subtitle">02186869345</p>
              </div>
            </div>
            <div class="col-lg-4">
              <div class="card card-feature text-center text-lg-left mb-4 mb-lg-0">
                ...
                <p class="card-feature__subtitle">PT.BARIQ ANUGERAH SEJAHTERAr</p>
              </div>
            </div>
          </div>
        </div>
...
Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved  <i class="fa fa-heart" aria-hidden="true"></i> by <a href="https://colorlib.com" target="_blank">PT.BARIQ ANUTGERAH SEJAHTERA</a>
